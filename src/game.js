class GameScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet("doux", "assets/sprites/doux.png", {
      frameWidth: 23.8,
      frameHeight: 17
    });
    this.load.spritesheet("bomb", "assets/sprites/bombs.png", {
      frameWidth: 14.5,
      frameHeight: 12
    });
      ...
      fetch(`https://cryptic-crag-84668.herokuapp.com/users` + `/${user_id}`)
        ...
        .then(data => {
          if (data.score < this.score) {
            fetch(
              `https://cryptic-crag-84668.herokuapp.com/users` + `/${user_id}`,
              {
                method: "PATCH",
                headers: {
